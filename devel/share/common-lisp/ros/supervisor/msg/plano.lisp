...
;//! \htmlinclude plano.msg.html

(cl:defclass <plano> (roslisp-msg-protocol:ros-message)
  ((upperleft
    :reader upperleft
    :initarg :upperleft
    :type cl:integer
...
(cl:defclass plano (<plano>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <plano>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'plano)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name supervisor-msg:<plano> is deprecated: use supervisor-msg:plano instead.")))

(cl:ensure-generic-function 'upperleft-val :lambda-list '(m))
(cl:defmethod upperleft-val ((m <plano>))
...
(cl:defmethod lowerRight-val ((m <plano>))
...
(cl:defmethod color-val ((m <plano>))
...
(cl:defmethod cameraID-val ((m <plano>))
  ...
  (cameraID m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <plano>) ostream)
  "Serializes a message object of type '<plano>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <plano>) istream)
  "Deserializes a message object of type '<plano>"
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<plano>)))
  "Returns string type for a message object of type '<plano>"
  "supervisor/plano")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'plano)))
  "Returns string type for a message object of type 'plano"
  "supervisor/plano")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<plano>)))
  "Returns md5sum for a message object of type '<plano>"
  "01ffaf0e26fa935372f1b74d92aa2818")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'plano)))
  "Returns md5sum for a message object of type 'plano"
  "01ffaf0e26fa935372f1b74d92aa2818")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<plano>)))
  "Returns full string definition for message of type '<plano>"
  (cl:format cl:nil "~%  int32 upperleft~%  int32 lowerRight~%  string color~%  string cameraID~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'plano)))
  "Returns full string definition for message of type 'plano"
  (cl:format cl:nil "~%  int32 upperleft~%  int32 lowerRight~%  string color~%  string cameraID~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <plano>))
  (cl:+ 0
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <plano>))
